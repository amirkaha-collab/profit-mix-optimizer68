...
.block-container { padding: 1.2rem 1.2rem 3rem !important; max-width: 1180px; }
...
<div class="pmo-header">
  <div class="pmo-header-left">
    ...
    <div>
      ...
      <div class="pmo-sub">אופטימיזציה לתמהיל מסלולי קרנות השתלמות</div>
    </div>
  </div>
  <div class="pmo-kpis">
    <div class="pmo-kpi"><span class="pmo-kpi-val">{n_records:,}</span><span class="pmo-kpi-lbl">קופות</span></div>
...
def render_results_table(rows, baseline, voting_configured):
  ...
  {sharpe_cell}
  <td class='num'>{fmt_val(rrow,'שירות משוקלל',False,0)}</td>
</tr>"""
...
<p style='font-size:10px;color:#9CA3AF;margin:2px 0 6px'>
  לחץ על שם החלופה לפרטים וסטטיסטיקה &nbsp;|&nbsp; * שארפ חסר — לא כל המסלולים בחלופה פרסמו מדד שארפ
</p>
""", unsafe_allow_html=True)
